// ✅ ProductCard.jsx — Enhanced and Reusable
            ...
            <div className="flex space-x-2 text-sm font-medium justify-start mt-5">
              {brandPage && (
                <button
                  ...
                  className="transition flex-1 ease-in duration-300 flex items-center text-sm font-medium bg-[#FF497C] px-5 py-2 hover:shadow-lg tracking-wider text-white rounded hover:bg-[#ab3154] justify-center"
                >
                  <span>Update</span>
                </button>
              )}
              <button
                ...
                className="transition flex-1 ease-in duration-300 bg-gray-700 hover:bg-gray-800 border border-gray-700 hover:border-gray-500 hover:text-white hover:shadow-lg text-white rounded py-2 text-center px-4 font-medium"
              >
                <span className="mr-2">
