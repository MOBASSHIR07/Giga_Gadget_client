...
const HomePage = () => {
  ...
  const categoryMatch = useMatch("/products/category/:brandName");
  ...
  return (
    <div className="">
      ...
      {/* ✅ Conditionally render products OR category */}
      <div className="gadgetContainer mt-20">
        <p className="font-semibold text-[#FF497C] mb-3 text-center md:text-left">
          <span className="bg-[#FF497C] text-white mr-3 text-xl px-2 py-1 rounded-full">
            ...
            {allProducts?.length > 8 && (
              <div className="mt-10 flex justify-center">
                <button
                  ...
                  className="text-white bg-[#FF497C] border-0 py-2 px-6 focus:outline-none hover:bg-[#ab3154] rounded font-semibold duration-200"
                >
